...
Behaviour
    ...
    2. Fields Entra does NOT provide (template, environment, description,
       ...
       Settings\plugin\entra-app-defaults.json. The tokens {{name}},
...
Examples
    ...
    .\Import-EntraAppRegistrations.ps1 -UseMockData -WhatIf
    .\Import-EntraAppRegistrations.ps1 -UseMockData

    # Live against the tenant:
    .\Import-EntraAppRegistrations.ps1
#>
...
$defaultsPath          = Join-Path $pluginRoot 'entra-app-defaults.json'
